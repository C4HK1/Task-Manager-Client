...
RoomCreationPage::RoomCreationPage(QQmlEngine *engine, QQuickItem *container, NetworkManager *net_manager) : BasePage(engine, container, "qml/RoomCreation.qml"), net_manager(net_manager) {
